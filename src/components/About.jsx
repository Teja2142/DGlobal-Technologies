...
import teamImg from '../assets/slide1.png';
    ...
    <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '0 20px', fontFamily: "'Arial', sans-serif", color: '#333' }}>
      ...
      <div style={{ textAlign: 'center', padding: '60px 20px', backgroundImage: `url(${aboutBg})`, backgroundSize: 'cover', backgroundPosition: 'center', backgroundRepeat: 'no-repeat', color: '#fff', marginBottom: '40px', position: 'relative' }}>
        <div style={{ backgroundColor: 'rgba(0, 0, 0, 0.6)', padding: '60px 20px' }}>
          <h1 style={{ fontSize: '2.5rem', fontWeight: 700, marginBottom: '20px' }}>About DGlobal Technology</h1>
          <p style={{ fontSize: '1.25rem', maxWidth: '700px', margin: '0 auto', lineHeight: '1.6' }}>
            DGlobal Technologies empowers small and medium businesses by delivering innovative, practical, and scalable digital solutions designed to help them thrive in today’s increasingly connected world.
          </p>
        </div>
      </div>
      {/* Who We Are */}
        ...
        <div style={{ display: 'flex', flexWrap: 'wrap', justifyContent: 'space-between', gap: '40px' }}>
          <div style={{ flex: '1', minWidth: '300px' }}>
            ...
            <p style={{ fontSize: '1rem', lineHeight: '1.6', marginBottom: '20px', color: '#555' }}>
              At DGlobal Technologies, we don’t just build digital solutions — we build digital momentum. Rooted in India, we focus on transforming small and medium enterprises into future-ready brands by crafting smart, scalable, and impactful digital experiences. In a world that moves fast, we ensure our clients move faster — with the right tools, the right technology, and the right strategy.
            </p>
            <p style={{ fontSize: '1rem', lineHeight: '1.6', marginBottom: '20px', color: '#555' }}>
        ...
        <div style={{ display: 'flex', flexWrap: 'wrap', justifyContent: 'center', gap: '40px', maxWidth: '1200px', margin: '0 auto' }}>
          <div style={{ flex: '1 1 400px', padding: '30px', backgroundColor: '#fff', borderRadius: '12px', boxShadow: '0 4px 10px rgba(0, 0, 0, 0.05)' }}>
            ...
            <p style={{ fontSize: '1.05rem', lineHeight: '1.7', color: '#555' }}>
              At DGlobal Technologies, we simplify digital transformation by delivering affordable, high-quality, and tailored digital solutions. Our mission is to be the trusted technology partner for ambitious entrepreneurs and growing enterprises, helping them harness the power of innovation to scale, compete, and succeed in today’s digital-first world.
            </p>
          </div>
          <div style={{ flex: '1 1 400px', padding: '30px', backgroundColor: '#fff', borderRadius: '12px', boxShadow: '0 4px 10px rgba(0, 0, 0, 0.05)' }}>
            <h3 style={{ fontSize: '1.75rem', fontWeight: '700', marginBottom: '20px', color: '#2c3e50' }}>Why We Exist</h3>
            <p style={{ fontSize: '1.05rem', lineHeight: '1.7', color: '#555' }}>
             DGlobal Technologies was founded with a clear vision: countless ambitious businesses were falling behind simply because they lacked the technical expertise to embrace digital transformation. We set out to change that — by combining the impact of enterprise-grade solutions with the care, agility, and commitment of a dedicated technology partner.            </p>
          </div>
        </div>
      </div>
