            ...
            <div style={{ marginBottom: "40px" }}>
              ...
              <div style={{ 
                ...
                <div style={{ 
                  ...
                  ':hover': {
                    background: "linear-gradient(135deg, #764ba2 0%, #1a1a2e 100%)",
                    color: "#fff",
          ...
          <div style={{ 
            ...
            <div style={{ 
              ...
              <div style={{
                ...
                bottom: "30px",
                width: "4px",
                background: "linear-gradient(to bottom, #764ba2, #1a1a2e)",
                borderRadius: "2px",
                zIndex: 1
              }}></div>
              ...
              {[
                ...
                <div key={index} style={{ 
                  ...
                  <div style={{ 
                    ...
                    transition: "all 0.4s ease",
                    ':hover': {
                      background: "linear-gradient(135deg, rgba(118, 75, 162, 0.1) 0%, rgba(26, 26, 46, 0.1) 100%)",
                ...
                <li key={index}>
                  <Link 
                    ...
                    style={{ 
                      ...
                      transition: "all 0.3s ease",
                      ':hover': {
                        background: "linear-gradient(90deg, #764ba2 0%, #1a1a2e 100%)",
                        color: "#fff",
